...
$('.playstore-coming-soon').click(function(){
   
 swal('Android App Info','Android App Coming Soon','info');
});

$('.app-store-coming-soon').click(function()
{
 swal('IOS App Info','IOS App Coming Soon','info');
});